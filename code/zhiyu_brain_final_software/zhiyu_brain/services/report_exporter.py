...
from zhiyu_brain.common.config import resolve_project_root
from zhiyu_brain.models.risk_model import RiskModel, trend_labels
...
class ReportExporter:
    ...
    def export_figures(self) -> list[Path]:
        ...
        files.append(self._save(fig,'01_system_overview.png','src/zhiyu_brain + services/gui_backend.py','SOFTWARE_IN_THE_LOOP',f'{risk_ver};{rank_ver}'))
