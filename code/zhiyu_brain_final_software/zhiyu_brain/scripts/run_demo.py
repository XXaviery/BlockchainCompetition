...
from zhiyu_brain.runtime.software_loop import UnifiedBrainRuntime


def main(argv: list[str] | None = None) -> None:
    parser = argparse.ArgumentParser(description='Run the Zhiyu Brain software-in-the-loop demo.')
