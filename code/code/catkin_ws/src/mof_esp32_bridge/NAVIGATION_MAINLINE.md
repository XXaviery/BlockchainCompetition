...
先完整阅读：
- catkin_ws/src/mof_esp32_bridge/NAVIGATION_MAINLINE.md
- catkin_ws/src/mof_esp32_bridge/SYNC_PROTOCOL.md
...
2. 只读发现树莓派实际源码包路径、install 前缀和当前 ROS 使用来源，不假设一定是 catkin_ws 或 ros2_ws。
